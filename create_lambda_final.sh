...
create_archive "${SCRIPT_DIR}/bacteria_only_dataset" "benchmark_bacteria_only_metadata"
...
echo "  - benchmark_phage_only_annotations.tar.gz    Pharokka annotations (869 test phages)"
echo "  - benchmark_bacteria_only_metadata.tar.gz    100 balanced bacteria metadata"
